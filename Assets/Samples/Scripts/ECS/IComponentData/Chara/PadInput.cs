...
{
	Vector2 axis;
	// public float axisTime;

	// public Vector2 axisBuffer;
	// public float axisBufferTime;
...
public struct Button
{
	...
	public void SetData(bool _isPush, bool _isPress, bool _isPop, float _time)
	{
